...
function ServiceEndpoint(sock) {
	...
	if(!sock.remoteAddress) {
		this.isRemote = false;
		this.address = '0.0.0.0:13777';

		this.serviceInfo = {
			name : 'Root Service',
			guid : aguid('root-service')
		}
...
ServiceEndpoint.prototype.sendMessage = function(message, data, dir) {
	try {
...
ServiceEndpoint.prototype.syncRequest = function(messageName, data) {
	...
	this.sendMessage(message, data, this.isRemote);
